            ...
            <div className="space-y-6">
              <div className="bg-dark-50 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <a href={`https://wa.me/${SITE_CONFIG.whatsapp}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 bg-emerald-50 rounded-xl hover:shadow-md transition-shadow border border-emerald-100">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-dark-900">Contact on WhatsApp</p>
                    </div>
                  </a>
